...
class BaseLossDerivatives(BaseDerivatives):
    ...
    def check_2nd_order_make_sense(self, module, g_inp, g_out):
        ...
        """
        self._check_output_is_scalar(module, g_inp, g_out)
        self._check_loss_has_not_been_modified(module, g_inp, g_out)

    def _check_output_is_scalar(self, module, g_inp, g_out):
    ...
    def _check_loss_has_not_been_modified(self, module, g_inp, g_out):
        """Should verify that `backward` was called on the module output."""
